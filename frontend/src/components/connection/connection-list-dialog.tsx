	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className="sm:max-w-[425px]">
					...
					<ScrollArea className="h-full">
						<div className="pr-4">
							{connections.map((item, index) => (
								...
								>
									<button
										className="flex-grow flex items-center justify-between  p-4 cursor-pointer"
									...
									<div className="flex items-center pr-2">
										<ConnectionEditDialog
											dialogTrigger={connectionEditTrigger}
											callback={GetListConnections}
											connection={item}
										/>
										<button
				...
				<DialogFooter>
					<ConnectionAddDialog
						dialogTrigger={connectionAddTrigger}
						callback={GetListConnections}
					/>
				</DialogFooter>
			</DialogContent>
