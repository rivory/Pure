...
export function QueryInterface({
    ...
    const handleKeyDown = (e: KeyboardEvent<HTMLDivElement>) => {
        ...
        const completionActive = document.querySelector(
    ...
    const saveEdit = async () => {
        ...
        try {
            const { rowIndex, colIndex, value, tableName, columnName } =
                editingCell;
            ...
            const whereConditions = results.columns
                .map((col, idx) => {
                ...
                <div className="flex-grow">
                    <CodeMirror
                        ...
                        extensions={[
                            sql(),
                            autocompletion({
                                override: [createSqlCompletions(tableInfo)],
                            }),
                            keymap.of([
                                {
                                    key: "Alt-Escape",
